...
from exp.exp_peak_detect_ltf_stsep import Exp_Peak_Detect_LTF_STSEP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, required=True, default='long_term_forecast',
                        help='task name, options:[long_term_forecast, peak_detect_ltf, peak_detect_ltf_stsep, peak_detect_ltf_basic, seq2peak, short_term_forecast, imputation, classification, anomaly_detection]')
    ...
    parser.add_argument('--dataset_config', type=str, default='', help='path to dataset_configs.json')
    parser.add_argument('--dataset_name', type=str, default='', help='dataset key in dataset_configs.json')
    parser.add_argument('--window_stride', type=int, default=4, help='window stride for STSEP-aligned datasets')
    ...
    if args.use_external_features and args.model == 'proposed_model' and args.task_name in ['peak_detect_ltf', 'peak_detect_ltf_stsep', 'peak_detect_ltf_basic']:
    ...
    elif args.task_name == 'peak_detect_ltf_stsep':
        Exp = Exp_Peak_Detect_LTF_STSEP
