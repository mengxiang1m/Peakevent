def print_args(args):
    ...
    print(f'  {"Patch Len:":<20}{args.patch_len:<20}')
    print()

    if hasattr(args, 'use_external_features'):
        print("\033[1m" + "External Features" + "\033[0m")
        print(f'  {"Use External:":<20}{args.use_external_features:<20}{"Mode:":<20}{getattr(args, "external_feature_mode", "concat"):<20}')
        print(f'  {"External Cols:":<20}{getattr(args, "external_feature_cols", ""):<20}{"Num External:":<20}{getattr(args, "num_external_features", 0):<20}')
        print()
