...
from models import Autoformer, Transformer, TimesNet, Nonstationary_Transformer, DLinear, FEDformer, \
    ...
    WPMixer, MultiPatchFormer, KANAD, CycleNet, STID, TQNet, APRN, MetaEformer, proposed_model, Transformer_d, \
    peak_Transformer, naive_baselines
...
class Exp_Basic(object):
    def __init__(self, args):
        ...
        self.model_dict = {
            ...
            'TQNet': TQNet,
            'APRN': APRN,
            'MetaEformer': MetaEformer, 
            'proposed_model': proposed_model,
            'Transformer_d': Transformer_d,
            'peak_Transformer': peak_Transformer,
            'NaiveBaseline': naive_baselines
        }
        if args.model == 'Mamba':
