...
def get_args():
    ...
    parser.add_argument('--dataset_config', type=str, default='', help='path to baselines/data/dataset_configs.json')
    parser.add_argument('--dataset_name', type=str, default='', help='dataset key in dataset_configs.json (e.g. wlel)')
    parser.add_argument('--window_stride', type=int, default=1, help='window stride for Dataset_STSEP_Seq2Peak')
    ...
    parser.add_argument('--inverse', action='store_true', default=False, help='inverse output data for test export')
...
if args.is_training:
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_busy_{}_{}_{}_{}_{}_{}'.format(args.model_id,
                                                                                                  ...
                                                                                                  args.distil,
                                                                                                  args.des, 
                                                                                                  args.busy_decoder,args.busy_ratio,args.busy_decoder_modal, args.hour_day,args.with_shift)
