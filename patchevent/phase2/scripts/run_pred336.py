"""
Phase2 E5-Full 实验 — pred_len=336 (96输入→336预测)

seq_len=96 (复用现有Phase1 checkpoints), pred_len=336
覆盖域: ett, elc (×3seeds)
输出: patchevent/phase2/checkpoints/{domain}_pred336/E5_full_s{seed}/
"""
...
OUT_BASE_TMPL = "patchevent/phase2/checkpoints/{domain}_pred336"
...
def main():
    ...
    for domain, cfg in DOMAINS.items():
        ...
        for seed in SEEDS:
            ...
            print("\n" + "=" * 64)
            print(f"[START] {domain}/E5_full_s{seed}  (pred_len=336)")
    ...
    print("\n" + "=" * 64)
    print(f"pred336 summary: total={total} done={done} skip={skip} fail={fail}")
    print("=" * 64)
